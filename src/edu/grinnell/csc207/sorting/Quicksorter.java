 ...
 * 
 * Citation: We referenced
 * "http://www.vogella.com/articles/JavaAlgorithmsQuicksort/article.html#quicksort_implementation"
 * when writing the partition method.
 */
public class Quicksorter<T> extends SorterBridge<T> {
     ...
     * 
     *       Loop invariant: ...For each j where lb < pivot < ub, values[pivot]
     */
